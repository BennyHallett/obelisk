defmodule Obelisk.Blog do
  ...
  def compile_index(posts, page_num) do
    ...
    File.write(html_filename(page_num),
      EEx.eval_string(layout, assigns: [js: Obelisk.Assets.js, css: Obelisk.Assets.css, content: EEx.eval_string(template, assigns: [content: Enum.map(posts, &(post_link &1))])]))
  end
